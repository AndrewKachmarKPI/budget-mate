...
export class BudgetViewComponent implements OnInit, OnChanges {
  ...
  private expenses=[
    {name:"Kek1",amount:500,date:"2023-05-12",category: {icon:"bx bx-pie-chart-alt bx-xs",name:"Entertainment"}},
    {name:"Kek2",amount:300,date:"2023-05-11",category: {icon:"bx bx-heart bx-xs",name:"Gachi"}},
    {name:"Kek3",amount:200,date:"2023-05-10",category: {icon:"bx bx-pie-chart-alt bx-xs",name:"Entertainment"}},
    {name:"Kek4",amount:200,date:"2023-05-09",category: {icon:"bx bx-pie-chart-alt bx-xs",name:"Entertainment"}},
    {name:"Kek5",amount:200,date:"2023-05-08",category: {icon:"bx bx-pie-chart-alt bx-xs",name:"Entertainment"}},
    {name:"Kek6",amount:200,date:"2023-05-07",category: {icon:"bx bx-pie-chart-alt bx-xs",name:"Entertainment"}},
  ]
